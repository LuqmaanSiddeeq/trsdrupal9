...
/* themes/custom/gavias_edmix/templates/node/node--key_information.html.twig */
class __TwigTemplate_96b1d1f20537880bec836ff3d17e57cf0c1e4e85e13e9f4626cd58a04897d80b extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<article";
  ...
  <div class=\"align-left style-default padding-bottom-30\">";
            // line 22
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_image_large_key", [], "any", false, false, true, 22), 22, $this->source), "html", null, true);
            echo "</div>
  <header>
    <div class=\"container\">
  ...
  <div";
    ...
    ";
            // line 33
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->withoutFilter($this->sandbox->ensureToStringAllowed(($context["content"] ?? null), 33, $this->source), "field_image_small_key", "field_image_large_key", "label", "comment"), "html", null, true);
            echo "
  </div>
</article>
...
";
    ...
    {
        return "themes/custom/gavias_edmix/templates/node/node--key_information.html.twig";
    }
    ...
    {
        return new Source("", "themes/custom/gavias_edmix/templates/node/node--key_information.html.twig", "/home/bestsols/public_html/dev1.bestsols.co.uk/themes/custom/gavias_edmix/templates/node/node--key_information.html.twig");
    }
